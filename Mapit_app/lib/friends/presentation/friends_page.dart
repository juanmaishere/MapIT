            ...
            listener: (context, state) {
              if (state is FriendsLoaded) {
                ...
                if (context.read<LocationBloc>().state is LocationLoaded) {
                  context
                      .read<LocationBloc>()
                      .add(LoadFriendsPost(friends: state.friends!));
                }
              }
              if (state is FriendAdded) {
                ...
                if (context.read<LocationBloc>().state is LocationLoaded) {
                  context
                      .read<LocationBloc>()
                      .add(LoadNewFriendPosts(friend: state.friend));
                }
              }
              if (state is FriendDeleted) {
                ...
                if (context.read<LocationBloc>().state is LocationLoaded) {
                  context
                      .read<LocationBloc>()
                      .add(DeleteFriendPosts(friend: state.friend));
                }
              }
              if (state is FriendError) {
                usernameErrorText = state.errorMessage;
              }
            },
          ),
                                    ...
                                    content: ConstrainedBox(
                                        ...
                                        child: Column(
                                          mainAxisSize: MainAxisSize
                                              .min, // Use min to limit the height
                                          children: [
                                            const Text(
